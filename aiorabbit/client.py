...
class Client(state.StateManager):
    ...
    STATE_CHANNEL_CLOSE_RECEIVED = 0x08
    STATE_CHANNEL_CLOSE_SENT = 0x09
    STATE_CHANNEL_CLOSEOK_RECEIVED = 0x10
    STATE_CHANNEL_FLOW_RECEIVED = 0x11
    STATE_CHANNEL_FLOWOK_SENT = 0x12
    STATE_CONFIRM_SELECT_SENT = 0x13
    STATE_CONFIRM_SELECTOK_RECEIVED = 0x14
    STATE_EXCHANGE_BIND_SENT = 0x15
    STATE_EXCHANGE_BINDOK_RECEIVED = 0x16
    STATE_EXCHANGE_DECLARE_SENT = 0x17
    STATE_EXCHANGE_DECLAREOK_RECEIVED = 0x18
    STATE_EXCHANGE_DELETE_SENT = 0x17
    STATE_EXCHANGE_DELETEOK_RECEIVED = 0x18
    STATE_EXCHANGE_UNBIND_SENT = 0x19
    STATE_EXCHANGE_UNBINDOK_RECEIVED = 0x20
    STATE_QUEUE_BIND_SENT = 0x21
    STATE_QUEUE_BINDOK_RECEIVED = 0x22
    STATE_QUEUE_DECLARE_SENT = 0x23
    STATE_QUEUE_DECLAREOK_RECEIVED = 0x24
    STATE_QUEUE_DELETE_SENT = 0X25
    STATE_QUEUE_DELETEOK_RECEIVED = 0X26
    STATE_QUEUE_PURGE_SENT = 0x27
    STATE_QUEUE_PURGEOK_RECEIVED = 0x28
    STATE_QUEUE_UNBIND_SENT = 0x29
    STATE_QUEUE_UNBINDOK_RECEIVED = 0x30
    STATE_TX_SELECT_SENT = 0x31
    STATE_TX_SELECTOK_RECEIVED = 0x32
    STATE_TX_COMMIT_SENT = 0x33
    STATE_TX_COMMITOK_RECEIVED = 0x34
    STATE_TX_ROLLBACK_SENT = 0x35
    STATE_TX_ROLLBACKOK_RECEIVED = 0x36
    STATE_BASIC_ACK_RECEIVED = 0x37
    STATE_BASIC_ACK_SENT = 0x38
    STATE_BASIC_CANCEL_RECEIVED = 0x39
    STATE_BASIC_CANCEL_SENT = 0x40
    STATE_BASIC_CANCELOK_RECEIVED = 0x41
    STATE_BASIC_CANCELOK_SENT = 0x42
    STATE_BASIC_CONSUME_SENT = 0x43
    STATE_BASIC_CONSUMEOK_RECEIVED = 0x44
    STATE_BASIC_DELIVER_RECEIVED = 0x45
    STATE_CONTENT_HEADER_RECEIVED = 0x46
    STATE_CONTENT_BODY_RECEIVED = 0x47
    STATE_BASIC_GET_SENT = 0x48
    STATE_BASIC_GETEMPTY_RECEIVED = 0x49
    STATE_BASIC_GETOK_RECEIVED = 0x50
    STATE_BASIC_NACK_RECEIVED = 0x51
    STATE_BASIC_NACK_SENT = 0x52
    STATE_BASIC_PUBLISH_SENT = 0x53
    STATE_CONTENT_HEADER_SENT = 0x54
    STATE_CONTENT_BODY_SENT = 0x55
    STATE_QOS_SENT = 0x56
    STATE_QOSOK_RECEIVED = 0x57
    STATE_RECOVER_SENT = 0x58
    STATE_RECOVEROK_RECEIVED = 0x59
    STATE_BASIC_REJECT_RECEIVED = 0x60
    STATE_BASIC_REJECT_SENT = 0x61
    STATE_BASIC_RETURN_RECEIVED = 0x62
    STATE_CLOSING = 0x63
    STATE_CLOSED = 0x64
    ...
    STATE_TRANSITIONS = {
        ...
        STATE_OPENED: [
            ...
            STATE_CLOSED],
        STATE_CHANNEL_OPEN_SENT: [
            STATE_CHANNEL_OPENOK_RECEIVED,
            STATE_CLOSED],
        STATE_CHANNEL_OPENOK_RECEIVED: IDLE_STATE,
        STATE_CHANNEL_CLOSE_RECEIVED: [
            STATE_CHANNEL_OPEN_SENT,
            STATE_CLOSED],
        STATE_CHANNEL_CLOSE_SENT: [
        ...
        STATE_CHANNEL_CLOSEOK_RECEIVED: [
            ...
            STATE_CLOSED],
        STATE_CHANNEL_FLOW_RECEIVED: [
            STATE_CHANNEL_FLOWOK_SENT,
            STATE_CLOSED],
        STATE_CHANNEL_FLOWOK_SENT: IDLE_STATE,
        STATE_CONFIRM_SELECT_SENT: [
            STATE_CONFIRM_SELECTOK_RECEIVED,
            STATE_CLOSED],
        STATE_CONFIRM_SELECTOK_RECEIVED: IDLE_STATE,
        STATE_EXCHANGE_BIND_SENT: [
            STATE_EXCHANGE_BINDOK_RECEIVED,
            STATE_CLOSED],
        STATE_EXCHANGE_BINDOK_RECEIVED: IDLE_STATE,
        STATE_EXCHANGE_DECLARE_SENT: [
            STATE_EXCHANGE_DECLAREOK_RECEIVED,
            STATE_CLOSED],
        STATE_EXCHANGE_DECLAREOK_RECEIVED: IDLE_STATE,
        STATE_EXCHANGE_DELETE_SENT: [
            STATE_EXCHANGE_DELETEOK_RECEIVED,
            STATE_CLOSED],
        STATE_EXCHANGE_DELETEOK_RECEIVED: IDLE_STATE,
        STATE_EXCHANGE_UNBIND_SENT: [
            STATE_EXCHANGE_UNBINDOK_RECEIVED,
            STATE_CLOSED],
        STATE_EXCHANGE_UNBINDOK_RECEIVED: IDLE_STATE,
        STATE_QUEUE_BIND_SENT: [
            STATE_QUEUE_BINDOK_RECEIVED,
            STATE_CLOSED],
        STATE_QUEUE_BINDOK_RECEIVED: IDLE_STATE,
        STATE_QUEUE_DECLARE_SENT: [
            STATE_QUEUE_DECLAREOK_RECEIVED,
            STATE_CLOSED],
        STATE_QUEUE_DECLAREOK_RECEIVED: IDLE_STATE,
        STATE_QUEUE_DELETE_SENT: [
            STATE_QUEUE_DELETEOK_RECEIVED,
            STATE_CLOSED],
        STATE_QUEUE_DELETEOK_RECEIVED: IDLE_STATE,
        STATE_QUEUE_PURGE_SENT: [
            STATE_QUEUE_PURGEOK_RECEIVED,
            STATE_CLOSED],
        STATE_QUEUE_PURGEOK_RECEIVED: IDLE_STATE,
        STATE_QUEUE_UNBIND_SENT: [
            STATE_QUEUE_UNBINDOK_RECEIVED,
            STATE_CLOSED],
        STATE_QUEUE_UNBINDOK_RECEIVED: IDLE_STATE,
        STATE_TX_SELECT_SENT: [
            STATE_TX_SELECTOK_RECEIVED,
            STATE_CLOSED],
        STATE_TX_SELECTOK_RECEIVED: IDLE_STATE + [
            STATE_TX_COMMIT_SENT,
            STATE_TX_ROLLBACK_SENT
        ],
        STATE_TX_COMMIT_SENT: [
            ...
            STATE_CLOSED],
        STATE_TX_COMMITOK_RECEIVED: IDLE_STATE,
        STATE_TX_ROLLBACK_SENT: [
            STATE_TX_ROLLBACKOK_RECEIVED,
            STATE_CLOSED],
        STATE_TX_ROLLBACKOK_RECEIVED: IDLE_STATE,
        STATE_BASIC_ACK_RECEIVED: IDLE_STATE,
        STATE_BASIC_ACK_SENT: IDLE_STATE,
        STATE_BASIC_CANCEL_RECEIVED: IDLE_STATE,
        STATE_BASIC_CANCEL_SENT: [
            STATE_BASIC_CANCELOK_RECEIVED],
        STATE_BASIC_CANCELOK_RECEIVED: IDLE_STATE,
        STATE_BASIC_CANCELOK_SENT: IDLE_STATE,
        STATE_BASIC_CONSUME_SENT: IDLE_STATE + [
            STATE_BASIC_CONSUMEOK_RECEIVED],
        STATE_BASIC_CONSUMEOK_RECEIVED: IDLE_STATE,
        STATE_BASIC_DELIVER_RECEIVED: [
        ...
        STATE_BASIC_GETEMPTY_RECEIVED: IDLE_STATE,
        STATE_BASIC_GETOK_RECEIVED: [
            STATE_CONTENT_HEADER_RECEIVED],
        STATE_BASIC_NACK_RECEIVED: IDLE_STATE,
        STATE_BASIC_NACK_SENT: IDLE_STATE,
        STATE_BASIC_PUBLISH_SENT: [
            STATE_CONTENT_HEADER_SENT],
        STATE_CONTENT_HEADER_SENT: [
            STATE_CONTENT_BODY_SENT],
        STATE_CONTENT_BODY_SENT: IDLE_STATE,
        STATE_QOS_SENT: [
            STATE_QOSOK_RECEIVED,
            STATE_CLOSED],
        STATE_QOSOK_RECEIVED: IDLE_STATE,
        STATE_RECOVER_SENT: [
            STATE_RECOVEROK_RECEIVED,
            STATE_CLOSED],
        STATE_RECOVEROK_RECEIVED: IDLE_STATE,
        STATE_BASIC_REJECT_RECEIVED: IDLE_STATE,
        STATE_BASIC_REJECT_SENT: IDLE_STATE,
        STATE_BASIC_RETURN_RECEIVED: [
            STATE_CONTENT_HEADER_RECEIVED],
    ...
    async def close(self) -> None:
        ...
        if self._channel0 and not self._channel0.is_closed:
    ...
    async def confirm_select(self) -> None:
        ...
        self._set_state(self.STATE_CONFIRM_SELECT_SENT)
        await self._wait_on_state(self.STATE_CONFIRM_SELECTOK_RECEIVED)
    ...
    async def publish(self,
        ...
        self._write(commands.Basic.Publish(
            ...
            immediate=immediate))
        self._set_state(self.STATE_BASIC_PUBLISH_SENT)
        ...
        self._write(header.ContentHeader(
            ...
            properties=commands.Basic.Properties(
                ...
                timestamp=timestamp,
                user_id=user_id)))
        self._set_state(self.STATE_CONTENT_HEADER_SENT)
        ...
        self._set_state(self.STATE_CONTENT_BODY_SENT)

        if self._publisher_confirms:
            result = await self._wait_on_state(
                self.STATE_CLOSED,
                self.STATE_CHANNEL_CLOSE_RECEIVED,
                self.STATE_BASIC_ACK_RECEIVED,
                self.STATE_BASIC_NACK_RECEIVED,
                self.STATE_BASIC_REJECT_RECEIVED)
            if result == self.STATE_BASIC_ACK_RECEIVED:
                return True
            return False
    ...
    async def _on_frame(self, channel: int, value: Frame) -> None:
        if channel == 0:
            ...
            self._set_state(self.STATE_CHANNEL_OPENOK_RECEIVED)
        elif value.name == 'Confirm.SelectOk':
            self._set_state(self.STATE_CONFIRM_SELECTOK_RECEIVED)
        else:
    ...
    async def _open_channel(self):
        ...
        self._set_state(self.STATE_CHANNEL_OPEN_SENT)
